let users,hashPassword,compPassword,jwt;_67f‍.x([["SignUp",()=>SignUp],["Login",()=>Login],["Logout",()=>Logout],["Users",()=>Users],["SingleUser",()=>SingleUser],["EditUser",()=>EditUser],["DeleteUser",()=>DeleteUser]]);_67f‍.w("../model/schema",[["default",["users"],function(v){users=v}]]);_67f‍.w("../utils/auth",[["hashPassword",["hashPassword"],function(v){hashPassword=v}],["compPassword",["compPassword"],function(v){compPassword=v}]]);_67f‍.w("jsonwebtoken",[["default",["jwt"],function(v){jwt=v}]]);
...
//Getting data from db for editing user-->
  ...
  _67f‍.g.console.log(findSingleUser);
};
//editing user---->
       const EditUser = async (req, res) => {
  _67f‍.g.console.log("backma data aako" + req.body.id);
